...
(
    ...
    splitt_type varchar(10) not null,
    emoji       varchar (2),
    note        varchar (250),
    date        date not null,
    ...
    constraint transactions_pk
        primary key (id),
    constraint transactions_added_by_fk
...
(
    ...
    constraint entries_pk
        primary key (id),
    constraint entries_user_id_fk
        foreign key (user_id) references users (id),
    constraint entries_group_id_fk
        foreign key (group_id) references groups (id),
    constraint entries_transaction_id_fk
